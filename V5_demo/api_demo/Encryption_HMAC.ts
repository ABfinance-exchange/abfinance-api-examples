...
const url = 'https://api-testnet.abfinance.com';
...
async function TestCase(): Promise<void> {
    ...
    let data = `{"category":"spot","symbol": "BTCUSDT","side": "Buy","orderType": "Limit","qty": "0.001","price": "10000","timeInForce": "GTC","orderLinkId": "${orderLinkId}"}`;
    ...
    data = `{"category":"spot","symbol": "BTCUSDT","orderLinkId": "${orderLinkId}"}`;
