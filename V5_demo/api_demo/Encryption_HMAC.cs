...
namespace Encryption_HMAC
{
    public class Encryption
    {
        ...
        private const string ApiSecret = "your_secret_key_here";
        ...
        public void PlaceOrder()
        {
            ...
            HttpRequestMessage request = new(HttpMethod.Post, "https://api-testnet.abfinance.com/v5/order/create")
            {
        ...
        public void GetOpenOrder()
        {
            ...
            using var client = new HttpClient();
            var request = new HttpRequestMessage(HttpMethod.Get, $"https://api-testnet.abfinance.com/v5/order/realtime?{queryString}");
            request.Headers.Add("X-BAPI-API-KEY", ApiKey);
            request.Headers.Add("X-BAPI-SIGN", signature);
            request.Headers.Add("X-BAPI-SIGN-TYPE", "2");
            request.Headers.Add("X-BAPI-TIMESTAMP", Timestamp);
