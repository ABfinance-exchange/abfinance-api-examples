...
const std::string Encryption::ApiKey = "your_api_key_here";
const std::string Encryption::ApiSecret = "your_secret_key_here";
...
void Encryption::PlaceOrder() {
    ...
    httplib::SSLClient client("api-testnet.abfinance.com", 443); // 443 is the default port for HTTPS
