...
var url string = "https://api-testnet.abfinance.com"
var api_key = "your_api_key_here"
var apiSecret = "your_secret_key_here"
...
func main() {
	...
	//POST Method
	postParams := map[string]interface{}{"category": "spot", "symbol": "BTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "0.001", "price": "10000", "timeInForce": "GTC"}
	postEndPoint := "/v5/order/create"
	postRequest(c, http.MethodPost, postParams, postEndPoint)

	//GET Method
	getEndPoint := "/v5/order/realtime"
	getParams := "category=spot&symbol=BTCUSDT"
