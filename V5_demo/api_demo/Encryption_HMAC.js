...
var data = '{"category":"spot","symbol": "BTCUSDT","side": "Buy","orderType": "Limit","qty": "0.001","price": "10000","timeInForce": "GTC","orderLinkId": "' + orderLinkId + '"}';
await http_request(endpoint,"POST",data,"Create");

//Get unfilled Order List
endpoint="/v5/order/realtime"
var data = 'category=spot&symbol=BTCUSDT';
await http_request(endpoint,"GET",data,"Order List");

//Cancel order
endpoint="/v5/order/cancel"
var data = '{"category":"spot","symbol": "BTCUSDT","orderLinkId": "'+orderLinkId+'"}';
