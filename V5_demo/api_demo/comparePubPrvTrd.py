...
URL="https://api-testnet.abfinance.com"
WssURL="wss://stream-testnet.abfinance.com"
topic="execution"
symbol="BTCUSDT"
...
def placeOrder(side):
    ...
    placePubUSDTOrder(json.dumps({"category":"spot","symbol": symbol,"side": side,"orderType": "Market","qty": "0.001","orderLinkId": orderLinkId}),currentTime,orderLinkId)
...
def connWsPub():
    ws = websocket.WebSocketApp(WssURL+"/v5/public/spot",
