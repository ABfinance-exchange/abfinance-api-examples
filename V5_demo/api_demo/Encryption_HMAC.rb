...
$recv_window = '5000'
$url = URI("https://api-testnet.abfinance.com") # Testnet endpoint
$time_stamp = ""
...
payload='{"category":"spot","symbol": "BTCUSDT","side": "Buy","orderType": "Limit","qty": "0.001","price": "10000","timeInForce": "GTC","orderLinkId": "' + orderLinkId + '"}'
...
method="POST"
payload='{"category":"spot","symbol": "BTCUSDT","orderLinkId": "'+orderLinkId+'"}'
HTTP_Request(endPoint,method,payload)
