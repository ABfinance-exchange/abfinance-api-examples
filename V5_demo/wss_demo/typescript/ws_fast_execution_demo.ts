...
const endpoint: string = "wss://stream-testnet.abfinance.com/v5/private";
console.log('attempting to connect to WebSocket %j', endpoint);

const client: WebSocket = new WebSocket(endpoint);
const apiKey: string = "your_api_key_here";
const apiSecret: string = "your_secret_key_here";
...
client.on('open', () => {
    ...
    client.ping();
    client.send(JSON.stringify({"op": "subscribe", "args": ['execution.fast']}));
});
