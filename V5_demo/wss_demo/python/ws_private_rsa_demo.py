...
if __name__ == "__main__":
    ...
    testnet_domain = "stream-testnet.abfinance.com"  # wss testnet
    mainnet_domain = "stream.abfinance.com"  # wss mainnet
    uta_path = "/v5/private"  # v5
    url_wss = f"wss://{testnet_domain}{uta_path}"

    rsa_apiKey = "your_api_key_here"  # the one that provided by ABFinance after you input rsa public key
