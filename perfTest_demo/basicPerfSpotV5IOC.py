...
def placeOrder():
    ...
    placeV5USDTOrder(json.dumps({"category":"spot","symbol": symbol,"side": "Buy","orderType": "Limit","qty": "0.0001","price": "20000","timeInForce": "IOC","orderLinkId": orderLinkId}),currentTime,orderLinkId)
...
def connWS():
    ws = websocket.WebSocketApp("wss://stream.abfinance.com/v5/private",
