...
api_key = 'xxxx'
api_secret = 'xxxx'
base_url = 'https://api-testnet.abfinance.com'
recv_window = '5000'
...
def create_order(category, symbol, qty, side, order_type):
    global time_stamp
    """ Function to create an order on ABFinance """
...
# Example usage
twap_order('spot', 'BTCUSDT', 1, 'Buy', 100, 10)  # TWAP over 100 mins, order every 10 minutes
