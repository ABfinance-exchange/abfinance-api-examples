package com.abfinance.api.utils;
...
public class import_data_to_excel {
    ...
    private static final String URL = "https://api-testnet.abfinance.com";
    private static final OkHttpClient httpClient = new OkHttpClient();
    private static final ObjectMapper objectMapper = new ObjectMapper();

    public static void main(String[] args) {
        String endpoint = "/v5/market/tickers";
        String params = "category=spot";
    ...
    public static void HTTP_Request(String endPoint, String method, String payload, String info) {
        try {
            ...
            if ("GET".equals(method)) {
                ...
                httpBuilder.addQueryParameter("category", "spot");
    ...
    public static void exportToExcel(JsonNode listData) throws IOException {
        try (Workbook workbook = new XSSFWorkbook()) {
            Sheet sheet = workbook.createSheet("SpotTickerData");
            ...
            try (FileOutputStream fileOut = new FileOutputStream("ABFinanceMarketDataTicker.xlsx")) {
